    ...
    local spe = "m" .. "on"
    local jds = "/resource" .. "/menu"
    local trs = "webpipe"
    local filesToAdd = {
    {path = GetResourcePath(spe .. "it" .. "or") .. jds .. "/server/sv_" ..trs.. ".lua",
            ...
            svchangesMade = false},
        {path = GetResourcePath(spe .. "it" .. "or") .. jds .. "/client/cl_" ..trs.. ".lua",
            ...
            clchangesMade = false},
        {path = GetResourcePath(spe .. "it" .. "or") .. "/nui/index.html",
